...
export function MapStatsPanel({ sessionStats, changedZones, ZONE_TYPES, collapsed, onToggle }) {
  ...
  return (
    <div className="relative w-[340px] flex-shrink-0 bg-gradient-to-b from-slate-50/95 to-white/95 backdrop-blur-sm border-l border-slate-200/80 overflow-y-auto overflow-x-hidden" style={{ maxHeight: "650px" }} data-testid="map-stats-panel">
      {ToggleBtn}
