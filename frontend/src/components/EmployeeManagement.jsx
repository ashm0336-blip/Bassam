          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3 justify-between">
              ...
              <div className="text-right">
                ...
                <p className="text-xs text-muted-foreground">{language === 'ar' ? 'غير نشطين' : 'Inactive'}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-2 justify-between">
              ...
              <div className="text-right">
                <p className="text-xl font-bold">{stats.shifts?.shift_1 || 0}</p>
                <p className="text-[10px] text-muted-foreground">{language === 'ar' ? 'الأولى' : 'Shift 1'}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-2 justify-between">
              ...
              <div className="text-right">
                <p className="text-xl font-bold">{stats.shifts?.shift_2 || 0}</p>
                <p className="text-[10px] text-muted-foreground">{language === 'ar' ? 'الثانية' : 'Shift 2'}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-2 justify-between">
              ...
              <div className="text-right">
                <p className="text-xl font-bold">{stats.shifts?.shift_3 || 0}</p>
                <p className="text-[10px] text-muted-foreground">{language === 'ar' ? 'الثالثة' : 'Shift 3'}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-2 justify-between">
              ...
              <div className="text-right">
                <p className="text-xl font-bold">{stats.shifts?.shift_4 || 0}</p>
                <p className="text-[10px] text-muted-foreground">{language === 'ar' ? 'الرابعة' : 'Shift 4'}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3 justify-between">
              ...
              <div className="text-right">
                <p className="text-2xl font-bold">{stats.locations_count || 0}</p>
